...
namespace TownOfHost
{
    ...
    public static class Options
    {
        ...
        public static CustomGameMode CurrentGameMode
        {
            get
            {
                switch (GameMode.CurrentValue)
                {
                    ...
                    case 2:
                        return CustomGameMode.BunnyHunt;
                    case 3:
        ...
        {
            "Standard", "HideAndSeek", "BunnyHunt", "FFA",
        };
        ...
        //BunnyHunt
        public static OptionItem AddSheriff;
        public static OptionItem SheriffCanTaskWin;
        public static OptionItem SheriffUltraHard;
        ...
        public static void Load()
        {
            ...
            // NK Counts
            MinNK = IntegerOptionItem.Create(100801, "MinNK", new(0, 15, 1), 0, TabGroup.MainSettings, true)
                .SetGameMode(CustomGameMode.Standard);
            MaxNK = IntegerOptionItem.Create(100802, "MaxNK", new(0, 15, 1), 3, TabGroup.MainSettings, true)
                .SetGameMode(CustomGameMode.Standard);
            ...
            DoctorTaskCompletedBatteryCharge = FloatOptionItem.Create(20710, "DoctorTaskCompletedBatteryCharge", new(0f, 100f, 10f), 50f, TabGroup.CrewmateRoles, false).SetParent(CustomRoleSpawnChances[CustomRoles.Doctor])
                .SetValueFormat(OptionFormat.Seconds);
            ...
            // BunnyHunt
            AddSheriff = BooleanOptionItem.Create(100803, "AddSheriff", true, TabGroup.MainSettings, true)
                .SetGameMode(CustomGameMode.BunnyHunt);
            SheriffCanTaskWin = BooleanOptionItem.Create(100804, "SheriffCanTaskWin", true, TabGroup.MainSettings, true).SetParent(AddSheriff)
                .SetGameMode(CustomGameMode.BunnyHunt);
            SheriffUltraHard = BooleanOptionItem.Create(100805, "SheriffUltraHard", true, TabGroup.MainSettings, true).SetParent(AddSheriff)
                .SetGameMode(CustomGameMode.BunnyHunt);
