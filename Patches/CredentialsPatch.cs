...
namespace TownOfHost
{
    ...
    class VersionShowerStartPatch
    {
        ...
        static void Postfix(VersionShower __instance)
        {
            ...
            if (Main.IsChristmas && CultureInfo.CurrentCulture.Name == "ja-JP")
            {
                ...
                SpecialEventText.text = "I don't know what to say, but it's a special day.\n<size=15%>\n\nExplode forever</size>";
    ...
    class TitleLogoPatch
    {
        ...
        static void Postfix(MainMenuManager __instance)
        {
            ...
            renderer.sprite = Utils.LoadSprite("TownOfHost.Resources.TownOfEmpath-Logo.png", 300f);
        }
    }
